 ...
 * @author apprentice
 */
public class ServiceTestingBase {

    protected JFoCategoryServiceLayer catServ;
    protected JFoCommentServiceLayer comServ;
    protected JFoImageServiceLayer imageServ;
    protected JFoPostServiceLayer postServ;
    protected JFoStaticPageServiceLayer pageServ;
    protected JFoTagServiceLayer tagServ;
    protected JFoUserServiceLayer userServ;
    ...
    public void setUp() {
        ...
        catServ = ctxFactory.getBean("categoryServiceLayer", JFoCategoryServiceLayer.class);
        comServ = ctxFactory.getBean("commentServiceLayer", JFoCommentServiceLayer.class);
        imageServ = ctxFactory.getBean("imageServiceLayer", JFoImageServiceLayer.class);
        postServ = ctxFactory.getBean("postServiceLayer", JFoPostServiceLayer.class);
        pageServ = ctxFactory.getBean("staticPageServiceLayer", JFoStaticPageServiceLayer.class);
        tagServ = ctxFactory.getBean("tagServiceLayer", JFoTagServiceLayer.class);
        userServ = ctxFactory.getBean("userServiceLayer", JFoUserServiceLayer.class);
