...
VALUES (1, "admin01", "password", 1, "Admin", "thisFirst", "thisLast", "email@gmail.com", 38.2527, -85.7585),
(2, "user01", "password", 1, "Author", "thatFirst", "thatLast", "that@email.com", 66.6666, 66.6666);
